...
typedef enum {
    ...
    DMA_OPT_APPLY_STEP_SIZE_TO_DST = 512,
    DMA_OPT_APPLY_STEP_SIZE_TO_SRC = 1024,
    DMA_OPT_DISABLE_SRC_INCREMENT = 2048,
    DMA_OPT_DISABLE_DST_INCREMENT = 4096,
    DMA_OPT_BLOCKACT_INT = 8196,
    DMA_OPT_BLOCKACT_SUSPEND = 16392,
    DMA_OPT_BLOCKACT_BOTH = 24588,
    DMA_OPT_EVENT_OUTPUT_BLOCK = 32768,
    DMA_OPT_EVENT_OUTPUT_BEAT = 65536,
...
typedef enum {
    DMA_PERIPHERAL_SERCOM0,
    DMA_PERIPHERAL_SERCOM1,
    DMA_PERIPHERAL_SERCOM2,
    DMA_PERIPHERAL_SERCOM3,
    DMA_PERIPHERAL_SERCOM4,
    DMA_PERIPHERAL_SERCOM5,
    DMA_PERIPHERAL_USB
} dma_peripheral_t;
