...
const i2c_state_t i2c_host_get_rx_state(const i2c_periph_inst_t i2c_peripheral_num) {
  volatile bustransaction_t *TransactionData = &sercom_bustrans_buffer[i2c_peripheral_num];
  if (TransactionData->rx_status == 0) {
    return I2C_RX_ACK;
  }
  return I2C_RX_NACK;
}

const i2c_state_t i2c_host_get_bus_state(const i2c_periph_inst_t i2c_peripheral_num) {
  volatile bustransaction_t *TransactionData = &sercom_bustrans_buffer[i2c_peripheral_num];
  switch (TransactionData->bus_state) {
    case 1:
