...
typedef union {
 ...
 /* !(defined(__ASSEMBLY__) || defined(volatile constAR_SYSTEMS_ASM__)) */
...
typedef union { // volatile const to avoid read-modify-write on write-to-clear register
  struct {
...
typedef struct {
  ...
  volatile uint8_t                    Reserved1[0x6];
  ...
  volatile uint8_t                    Reserved2[0x8];
  ...
  volatile uint8_t                    Reserved4[0x1];
